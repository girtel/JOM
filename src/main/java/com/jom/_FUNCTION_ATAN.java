...
class _FUNCTION_ATAN extends Expression
{
	...
	DoubleMatrix2D nl_evaluateJacobian(double[] valuesDVs)
	{
		...
		return  DoubleFactory2D.sparse.diagonal(a_value.assign(DoubleFunctions.square).assign(DoubleFunctions.plus(1)).assign(DoubleFunctions.inv)).zMult(a_jacobian, null);
	}
