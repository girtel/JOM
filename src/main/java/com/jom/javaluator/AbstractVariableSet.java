...
/** An abstract variable set. <br> Javaluator supports expression that contains variables (for example <i>sin(x)</i>). <br> An AbstractVariableSet
 * converts, during the expression evaluation, each variable to its value.
 *
