...
public interface _JNA_GLPK extends Library
{
	...
	public static class GLP_IOCP extends Structure
	{
		...
		{
			return Arrays.asList(new String[] { "msg_lev", "br_tech", "bt_tech", "tol_int", "tol_obj", "tm_lim", "out_frq", "out_dly", "cb_func", "cb_info", "cb_size", "pp_tech", "mip_gap", "mir_cuts", "gmi_cuts", "cov_cuts", "clq_cuts", "presolve", "binarize", "fp_heur", "alien", "foo_bar" });
		}
	}
	...
	public static class GLP_SMCP extends Structure
	{
		...
		protected List getFieldOrder()
		{
			return Arrays.asList(new String[] { "msg_lev", "meth", "pricing", "r_test", "tol_bnd", "tol_dj", "tol_piv", "obj_ll", "obj_ul", "it_lim", "tm_lim", "out_frq", "out_dly", "presolve", "foo_bar" });
		}
	}
